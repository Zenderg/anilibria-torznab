...
```text
ghcr.io/zenderg/anilibria-torznab:v1.0.3
```
...
```bash
git clone --branch v1.0.3 --depth 1 https://github.com/Zenderg/anilibria-torznab.git
cd anilibria-torznab

API_KEY="$(openssl rand -hex 32)"
umask 077
printf 'API_KEY=%s\nPORT=8080\nIMAGE=ghcr.io/zenderg/anilibria-torznab:v1.0.3\n' "$API_KEY" > .env
